...
// Modified by:
// Created:     04/01/98
// RCS-ID:      $Id: docview.cpp,v 1.2 2003/12/31 06:07:55 aaron_newman Exp $
...
bool MyApp::OnInit(void)
{
    ...
    (void) new wxDocTemplate(m_docManager, "Drawing", "*.abc", "", "abc", "ABC Doc", "ABC View",
    ...
    frame = new MyFrame(m_docManager, (wxFrame *) NULL, -1, "Figure Unit Test", wxPoint(0, 0), wxSize(500, 400), wxDEFAULT_FRAME_STYLE);
...
iabc::wx_view_canvas *MyFrame::CreateCanvas(wxView *view, wxFrame *parent)
{
    int width, height;
	...
	iabc::wx_view_canvas *canvas = new 
		iabc::wx_view_canvas(view, parent, wxPoint(0, 0), wxSize(width, height), 0);
